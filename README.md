...
扩展不请求浏览记录、标签页、定位或其他额外权限。庭院由 Three.js 渲染，使用本地打包的 Poly Haven CC0 材质、实拍山景与 HDR 光照、EZ-Tree 枝叶模型，以及程序生成的锦鲤、茶具、风铃与天气。扩展运行时不依赖远程脚本、资产或字体。网页版本由 GitHub Pages 提供静态文件。完整来源与许可见 [资产说明](docs/ASSETS.md)。
